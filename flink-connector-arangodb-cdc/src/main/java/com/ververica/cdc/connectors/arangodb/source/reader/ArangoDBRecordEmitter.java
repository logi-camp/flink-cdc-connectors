...
import static com.ververica.cdc.connectors.arangodb.source.utils.ArangoDBRecordUtils.getFetchTimestamp;
import static com.ververica.cdc.connectors.arangodb.source.utils.ArangoDBRecordUtils.getMessageTimestamp;
import static com.ververica.cdc.connectors.arangodb.source.utils.ArangoDBRecordUtils.getResumeToken;
import static com.ververica.cdc.connectors.arangodb.source.utils.ArangoDBRecordUtils.isDataChangeRecord;
 ...
 */
public final class ArangoDBRecordEmitter<T> extends IncrementalSourceRecordEmitter<T> {

    private static final Logger LOG = LoggerFactory.getLogger(ArangoDBRecordEmitter.class);

    public ArangoDBRecordEmitter(
