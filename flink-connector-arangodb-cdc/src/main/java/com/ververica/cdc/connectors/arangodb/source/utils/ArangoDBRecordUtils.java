...
import static com.ververica.cdc.connectors.arangodb.internal.ArangoDBEnvelope.COPY_KEY_FIELD;
...
import static com.ververica.cdc.connectors.arangodb.internal.ArangoDBEnvelope.JSON_WRITER_SETTINGS_STRICT;
import static com.ververica.cdc.connectors.arangodb.internal.ArangoDBEnvelope.NAMESPACE_FIELD;
import static com.ververica.cdc.connectors.arangodb.internal.ArangoDBEnvelope.SOURCE_RECORD_KEY_SCHEMA;
import static com.ververica.cdc.connectors.arangodb.internal.ArangoDBEnvelope.SOURCE_RECORD_VALUE_SCHEMA;
...
public class ArangoDBRecordUtils {

    private ArangoDBRecordUtils() {}
    ...
    public static boolean isHeartbeatEvent(SourceRecord sourceRecord) {
        return "true".equals(getOffsetValue(sourceRecord, ArangoDBEnvelope.HEARTBEAT_KEY_FIELD));
    }
    ...
    public static BsonDocument getResumeToken(SourceRecord sourceRecord) {
        return BsonDocument.parse(getOffsetValue(sourceRecord, ArangoDBEnvelope.ID_FIELD));
    }
    ...
    public static BsonDocument getDocumentKey(SourceRecord sourceRecord) {
        ...
        return BsonDocument.parse(value.getString(ArangoDBEnvelope.DOCUMENT_KEY_FIELD));
    }
    ...
    public static TableId getTableId(SourceRecord dataRecord) {
        ...
        Struct source = value.getStruct(ArangoDBEnvelope.NAMESPACE_FIELD);
        String dbName = source.getString(ArangoDBEnvelope.NAMESPACE_DATABASE_FIELD);
        String collName = source.getString(ArangoDBEnvelope.NAMESPACE_COLLECTION_FIELD);
