...
import static com.ververica.cdc.connectors.arangodb.source.config.ArangoDBSourceOptions.COLLECTION;
import static com.ververica.cdc.connectors.arangodb.source.config.ArangoDBSourceOptions.CONNECTION_OPTIONS;
import static com.ververica.cdc.connectors.arangodb.source.config.ArangoDBSourceOptions.DATABASE;
import static com.ververica.cdc.connectors.arangodb.source.config.ArangoDBSourceOptions.FULL_DOCUMENT_PRE_POST_IMAGE;
import static com.ververica.cdc.connectors.arangodb.source.config.ArangoDBSourceOptions.HEARTBEAT_INTERVAL_MILLIS;
import static com.ververica.cdc.connectors.arangodb.source.config.ArangoDBSourceOptions.HOSTS;
import static com.ververica.cdc.connectors.arangodb.source.config.ArangoDBSourceOptions.INITIAL_SNAPSHOTTING_QUEUE_SIZE;
import static com.ververica.cdc.connectors.arangodb.source.config.ArangoDBSourceOptions.PASSWORD;
...
import static com.ververica.cdc.connectors.arangodb.source.config.ArangoDBSourceOptions.SCAN_INCREMENTAL_SNAPSHOT_ENABLED;
import static com.ververica.cdc.connectors.arangodb.source.config.ArangoDBSourceOptions.SCAN_NO_CURSOR_TIMEOUT;
import static com.ververica.cdc.connectors.arangodb.source.config.ArangoDBSourceOptions.SCHEME;
import static com.ververica.cdc.connectors.arangodb.source.config.ArangoDBSourceOptions.USERNAME;
import static com.ververica.cdc.debezium.utils.ResolvedSchemaUtils.getPhysicalSchema;
import static org.apache.flink.util.Preconditions.checkArgument;
import static org.apache.flink.util.Preconditions.checkNotNull;

/** Factory for creating configured instance of {@link ArangoDBTableSource}. */
public class ArangoDBTableSourceFactory implements DynamicTableSourceFactory {
    ...
    public DynamicTableSource createDynamicTableSource(Context context) {
        ...
        return new ArangoDBTableSource(
                physicalSchema,
                scheme,
                hosts,
                username,
