 ...
 */
@PublicEvolving
public class ArangoDBConnectorDeserializationSchema
    ...
    public ArangoDBConnectorDeserializationSchema(
    ...
    protected OperationType operationTypeFor(SourceRecord record) {
        Struct value = (Struct) record.value();
        return OperationType.fromString(value.getString(ArangoDBEnvelope.OPERATION_TYPE_FIELD));
    }
