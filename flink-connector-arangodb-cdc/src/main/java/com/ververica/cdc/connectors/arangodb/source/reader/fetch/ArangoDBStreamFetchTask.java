...
import static com.ververica.cdc.connectors.arangodb.internal.ArangoDBEnvelope.CLUSTER_TIME_FIELD;
import static com.ververica.cdc.connectors.arangodb.internal.ArangoDBEnvelope.DOCUMENT_KEY_FIELD;
import static com.ververica.cdc.connectors.arangodb.internal.ArangoDBEnvelope.HEARTBEAT_TOPIC_NAME;
import static com.ververica.cdc.connectors.arangodb.internal.ArangoDBEnvelope.HEARTBEAT_VALUE_SCHEMA;
import static com.ververica.cdc.connectors.arangodb.internal.ArangoDBEnvelope.ID_FIELD;
import static com.ververica.cdc.connectors.arangodb.internal.ArangoDBEnvelope.NAMESPACE_COLLECTION_FIELD;
import static com.ververica.cdc.connectors.arangodb.internal.ArangoDBEnvelope.NAMESPACE_DATABASE_FIELD;
import static com.ververica.cdc.connectors.arangodb.internal.ArangoDBEnvelope.NAMESPACE_FIELD;
import static com.ververica.cdc.connectors.arangodb.internal.ArangoDBEnvelope.OPERATION_TYPE_FIELD;
import static com.ververica.cdc.connectors.arangodb.internal.ArangoDBEnvelope.SNAPSHOT_KEY_FIELD;
import static com.ververica.cdc.connectors.arangodb.internal.ArangoDBEnvelope.SOURCE_FIELD;
import static com.ververica.cdc.connectors.arangodb.internal.ArangoDBEnvelope.TIMESTAMP_KEY_FIELD;
import static com.ververica.cdc.connectors.arangodb.internal.ArangoDBEnvelope.WATERMARK_TOPIC_NAME;
import static com.ververica.cdc.connectors.arangodb.source.offset.ChangeStreamOffset.NO_STOPPING_OFFSET;
import static com.ververica.cdc.connectors.arangodb.source.utils.ArangoDBRecordUtils.bsonTimestampFromEpochMillis;
import static com.ververica.cdc.connectors.arangodb.source.utils.ArangoDBRecordUtils.createHeartbeatPartitionMap;
import static com.ververica.cdc.connectors.arangodb.source.utils.ArangoDBRecordUtils.createPartitionMap;
import static com.ververica.cdc.connectors.arangodb.source.utils.ArangoDBRecordUtils.createSourceOffsetMap;
import static com.ververica.cdc.connectors.arangodb.source.utils.ArangoDBRecordUtils.createSourceRecord;
import static com.ververica.cdc.connectors.arangodb.source.utils.ArangoDBRecordUtils.createWatermarkPartitionMap;
import static com.ververica.cdc.connectors.arangodb.source.utils.ArangoDBRecordUtils.currentBsonTimestamp;
import static com.ververica.cdc.connectors.arangodb.source.utils.ArangoDBRecordUtils.getResumeToken;
import static com.ververica.cdc.connectors.arangodb.source.utils.ArangoDBUtils.FAILED_TO_PARSE_ERROR;
import static com.ververica.cdc.connectors.arangodb.source.utils.ArangoDBUtils.ILLEGAL_OPERATION_ERROR;
import static com.ververica.cdc.connectors.arangodb.source.utils.ArangoDBUtils.UNAUTHORIZED_ERROR;
import static com.ververica.cdc.connectors.arangodb.source.utils.ArangoDBUtils.UNKNOWN_FIELD_ERROR;
import static com.ververica.cdc.connectors.arangodb.source.utils.ArangoDBUtils.clientFor;
import static com.ververica.cdc.connectors.arangodb.source.utils.ArangoDBUtils.getChangeStreamIterable;
...
public class ArangoDBStreamFetchTask implements FetchTask<SourceSplitBase> {

    private static final Logger LOG = LoggerFactory.getLogger(ArangoDBStreamFetchTask.class);

    private final StreamSplit streamSplit;
    private volatile boolean taskRunning = false;

    private ArangoDBSourceConfig sourceConfig;
    private final Time time = new SystemTime();
    private boolean supportsStartAtOperationTime = true;
    private boolean supportsStartAfter = true;

    public ArangoDBStreamFetchTask(StreamSplit streamSplit) {
        this.streamSplit = streamSplit;
    }

    @Override
    public void execute(Context context) throws Exception {
        ArangoDBFetchTaskContext taskContext = (ArangoDBFetchTaskContext) context;
