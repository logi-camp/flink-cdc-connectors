...
import static com.ververica.cdc.connectors.arangodb.internal.ArangoDBEnvelope.FULL_DOCUMENT_FIELD;
...
import static com.ververica.cdc.connectors.arangodb.source.utils.ArangoDBUtils.collectionFor;

/** The task to work for fetching data of ArangoDB collection snapshot split . */
public class ArangoDBScanFetchTask implements FetchTask<SourceSplitBase> {

    private static final Logger LOG = LoggerFactory.getLogger(ArangoDBScanFetchTask.class);

    private final SnapshotSplit snapshotSplit;
    private volatile boolean taskRunning = false;

    public ArangoDBScanFetchTask(SnapshotSplit snapshotSplit) {
    ...
    public void execute(Context context) throws Exception {
        ...
        ArangoDBSourceConfig sourceConfig = taskContext.getSourceConfig();
        ArangoDBDialect dialect = taskContext.getDialect();
        ...
        try {
            ...
            if (!streamBackfillRequired) {
                ...
                ArangoDBStreamFetchTask backfillStreamTask =
                        new ArangoDBStreamFetchTask(backfillStreamSplit);
