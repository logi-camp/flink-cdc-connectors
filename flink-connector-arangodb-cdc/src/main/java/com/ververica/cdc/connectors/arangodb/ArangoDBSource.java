...
package com.ververica.cdc.connectors.arangodb;
...
import com.ververica.cdc.connectors.arangodb.internal.ArangoDBConnectorSourceConnector;
...
import static com.ververica.cdc.connectors.arangodb.internal.ArangoDBConnectorSourceTask.COLLECTION_INCLUDE_LIST;
import static com.ververica.cdc.connectors.arangodb.internal.ArangoDBConnectorSourceTask.DATABASE_INCLUDE_LIST;
import static com.ververica.cdc.connectors.arangodb.internal.ArangoDBConnectorSourceTask.STARTUP_MODE_INITIAL_SNAPSHOTTING_MAX_THREADS_CONFIG;
import static com.ververica.cdc.connectors.arangodb.internal.ArangoDBConnectorSourceTask.STARTUP_MODE_INITIAL_SNAPSHOTTING_PIPELINE_CONFIG;
import static com.ververica.cdc.connectors.arangodb.internal.ArangoDBConnectorSourceTask.STARTUP_MODE_INITIAL_SNAPSHOTTING_QUEUE_SIZE_CONFIG;
import static com.ververica.cdc.connectors.arangodb.internal.ArangoDBConnectorSourceTask.STARTUP_MODE_TIMESTAMP_START_AT_OPERATION_TIME_CONFIG;
...
import static com.ververica.cdc.connectors.arangodb.internal.ArangoDBEnvelope.OUTPUT_SCHEMA;
...
import static com.ververica.cdc.connectors.arangodb.source.utils.ArangoDBUtils.buildConnectionString;
...
public class ArangoDBSource {
    ...
    /** Builder class of {@link ArangoDBSource}. */
    public static class Builder<T> {
        ...
        public DebeziumSourceFunction<T> build() {
            ...
            props.setProperty(
                    "connector.class", ArangoDBConnectorSourceConnector.class.getCanonicalName());
            props.setProperty("name", "arangodb_cdc_source");
