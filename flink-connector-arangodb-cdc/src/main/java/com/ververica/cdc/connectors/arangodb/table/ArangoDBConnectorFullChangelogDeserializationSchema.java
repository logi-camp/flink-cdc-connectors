 ...
 */
@PublicEvolving
public class ArangoDBConnectorFullChangelogDeserializationSchema
        extends ArangoDBConnectorDeserializationSchema {

    private static final long serialVersionUID = 1750787080613035184L;

    public ArangoDBConnectorFullChangelogDeserializationSchema(
    ...
    public void deserialize(SourceRecord record, Collector<RowData> out) throws Exception {
        ...
        BsonDocument documentKey =
                extractBsonDocument(value, valueSchema, ArangoDBEnvelope.DOCUMENT_KEY_FIELD);
        BsonDocument fullDocument =
                extractBsonDocument(value, valueSchema, ArangoDBEnvelope.FULL_DOCUMENT_FIELD);

        BsonDocument fullDocumentBeforeChange =
                extractBsonDocument(
                        value, valueSchema, ArangoDBEnvelope.FULL_DOCUMENT_BEFORE_CHANGE_FIELD);
