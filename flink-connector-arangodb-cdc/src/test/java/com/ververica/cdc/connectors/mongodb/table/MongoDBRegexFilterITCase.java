...
import static com.ververica.cdc.connectors.arangodb.utils.MongoDBTestUtils.waitForSinkSize;
import static com.ververica.cdc.connectors.arangodb.utils.MongoDBTestUtils.waitForSnapshotStarted;
import static org.hamcrest.Matchers.containsInAnyOrder;
import static org.junit.Assert.assertThat;

/** Integration tests to check mongodb-cdc works well under namespace.regex. */
@RunWith(Parameterized.class)
public class MongoDBRegexFilterITCase extends ArangoDBSourceTestBase {
