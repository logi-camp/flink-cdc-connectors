...
import com.ververica.cdc.connectors.arangodb.source.utils.ArangoDBUtils;
import com.ververica.cdc.connectors.arangodb.utils.MongoDBTestUtils;
...
import static com.ververica.cdc.connectors.arangodb.utils.MongoDBAssertUtils.assertEqualsInAnyOrder;
...
import static com.ververica.cdc.connectors.arangodb.utils.MongoDBTestUtils.fetchRows;
import static com.ververica.cdc.connectors.arangodb.utils.MongoDBTestUtils.triggerFailover;
import static org.apache.flink.util.Preconditions.checkState;
import static org.junit.Assert.assertEquals;

/** Integration tests for MongoDB full document before change info. */
@RunWith(Parameterized.class)
public class MongoDBFullChangelogITCase extends ArangoDBSourceTestBase {
    ...
    public void testGetMongoDBVersion() {
        ...
        assertEquals(ArangoDBUtils.getMongoVersion(config), "6.0.6");
    }
