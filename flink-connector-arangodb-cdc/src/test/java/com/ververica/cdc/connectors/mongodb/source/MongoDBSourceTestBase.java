...
import com.ververica.cdc.connectors.arangodb.utils.MongoDBContainer;
...
public class ArangoDBSourceTestBase {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(ArangoDBSourceTestBase.class);
