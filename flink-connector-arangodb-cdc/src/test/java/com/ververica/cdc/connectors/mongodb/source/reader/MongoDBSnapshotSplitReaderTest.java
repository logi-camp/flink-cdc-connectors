...
package com.ververica.cdc.connectors.arangodb.source.reader;
...
import com.ververica.cdc.connectors.arangodb.source.ArangoDBSourceTestBase;
import com.ververica.cdc.connectors.arangodb.source.assigners.splitters.SampleBucketSplitStrategy;
import com.ververica.cdc.connectors.arangodb.source.assigners.splitters.ShardedSplitStrategy;
import com.ververica.cdc.connectors.arangodb.source.assigners.splitters.SingleSplitStrategy;
import com.ververica.cdc.connectors.arangodb.source.assigners.splitters.SplitContext;
import com.ververica.cdc.connectors.arangodb.source.assigners.splitters.SplitStrategy;
import com.ververica.cdc.connectors.arangodb.source.assigners.splitters.SplitVectorSplitStrategy;
...
import static com.ververica.cdc.connectors.arangodb.utils.MongoDBContainer.FLINK_USER;
import static com.ververica.cdc.connectors.arangodb.utils.MongoDBContainer.FLINK_USER_PASSWORD;
import static java.util.Collections.singletonList;
import static org.junit.Assert.assertEquals;
import static org.junit.Assert.assertTrue;

/** MongoDB snapshot split reader test case. */
public class MongoDBSnapshotSplitReaderTest extends ArangoDBSourceTestBase {
    ...
    private ArangoDBDialect dialect;
    ...
    public void before() {
        ...
        ArangoDBSourceConfigFactory configFactory =
                new ArangoDBSourceConfigFactory()
    ...
    private void testMongoDBSnapshotSplitReader(SplitStrategy splitter) throws Exception {
        ...
        IncrementalSourceSplitReader<ArangoDBSourceConfig> snapshotSplitReader =
